...
function DropdownHelp({ align }) {
  ...
  return (
    <div className="relative inline-flex">
      <button
        ref={dropdown}
        className="w-8 h-8 flex items-center justify-center hover:bg-gray-100 lg:hover:bg-gray-200 dark:hover:bg-gray-700/50 dark:lg:hover:bg-gray-800 rounded-full bg-gray-200 dark:bg-gray-800"
        aria-haspopup="true"
        aria-expanded="true"
      >
      ...
      >
        <div ref={dropdown}>
          ...
          <ul>
            <li>
              <Link className="font-medium text-sm text-violet-500 hover:text-violet-600 dark:hover:text-violet-400 flex items-center py-1 px-3" to="#0">
