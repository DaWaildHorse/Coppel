...
function DashboardCard01() {
  ...
  useEffect(() => {
    const fetchAPI = async () => {
      try {
        const response = await axios.get("http://localhost:8080/dash2");
        ...
        setChartData({
          ...
          datasets: [
            {
              label: "Estados con mayor tiempo de Espera",
              data: values,
    ...
    <div className="col-span-full xl:col-span-8 bg-white dark:bg-gray-800 shadow-xs rounded-xl">
      <div className="px-5 pt-5">
        <header className="flex justify-between items-start mb-2">
          <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100">Estados con mayor tiempo de atencion</h2>
